...
def about_setup(notebook):
    ...
    table.rowconfigure(index=4, weight=0, minsize=20)
    table.rowconfigure(index=5, weight=0, minsize=5)
    table.rowconfigure(index=6, weight=0, minsize=20)
    table.rowconfigure(index=7, weight=0, minsize=20)
    ...
    lbl_obs = Label(master=table,justify=LEFT, text="https://obsproject.com/forum/resources/gamemaster.1441/", font=("Arial",10,""), relief=SUNKEN, padding=5)
    lbl_obs.grid(sticky=NSEW, row=1, column=1)
    ...
    btn_latest.grid(sticky=NSEW, row=2, column=0)
    ...
    lbl_issues.grid(sticky=NSEW, row=4, column=1)
    ...
    btn_source.grid(sticky=NSEW, row=6, column=0)
    ...
    lbl_source.grid(sticky=NSEW, row=6, column=1)
    ...
    btn_license.grid(sticky=NSEW, row=7, column=0)
    ...
    kofi = tk.Frame(master=links, height=1, relief=RAISED, bd="2")
    kofi.rowconfigure(index=0, weight=0)
    kofi.rowconfigure(index=1, weight=0)
    kofi.columnconfigure(index=0, weight=10)
    kofi.columnconfigure(index=1, weight=1)
    kofi.columnconfigure(index=2, weight=10)
    kofi.grid(row=1, column=0, sticky=NSEW, padx=5, pady=2.5)
    img_kofi = Image.open(resource_path("kofi.png"))
    img_kofi = img_kofi.resize((int(96*1.3),int(33*1.3)), Image.ANTIALIAS)
    img_kofi = ImageTk.PhotoImage(img_kofi)
    lbl_kofi = Label(master=kofi, image=img_kofi, width=96, justify=CENTER)
    lbl_kofi.image = img_kofi
    lbl_kofi.grid(row=0, column=1, sticky=NSEW, padx=5, pady=5)
    ...
    doc.grid(row=2, column=0, sticky=NSEW, padx=5, pady=2.5)
    ...
    datastream.grid(row=3, column=0, sticky=NSEW, padx=5, pady=2.5)
    ...
    github.grid(row=4, column=0, sticky=NSEW, padx=5, pady=2.5)
