...
lbl_home.grid(sticky=NSEW,row=0,column=0,columnspan=2)
...
lbl_home = Label(master=homeframe,text="Home",font=("Arial",14,""), width=2)
...
lbl_away = Label(master=awayframe,text="Away",font=("Arial",14,""), width=2)
